      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <a
            ...
            className="hidden sm:flex relative group overflow-hidden items-center gap-2 px-3 py-1.5 border border-gray-300 text-gray-600 transition-all text-sm hover:text-white"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:flex relative group overflow-hidden w-9 h-9 border border-gray-300 items-center justify-center text-gray-600 transition-all hover:text-white"
          >
          ...
          <a
            href="/signup"
            className="relative group overflow-hidden border border-gray-900 text-gray-900 text-xs sm:text-sm font-medium px-3 sm:px-4 py-1.5 sm:py-2 transition-all hover:text-white"
          >
