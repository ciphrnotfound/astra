    ...
    <aside className="w-64 bg-white border-r border-gray-200 min-h-screen">
      <div className="p-6">
        ...
        <Link href="/" className="flex items-center gap-2 mb-8">
          <div className="w-8 h-8 border border-gray-900 bg-white flex items-center justify-center shrink-0">
            <img src="/astra-logo-2.jpg" alt="Astra Logo" className="w-full h-full object-contain" />
          </div>
          <span className="text-lg font-medium text-gray-900 tracking-tight" style={{ fontFamily: 'var(--font-space-grotesk)' }}>
            Astra
          </span>
        </Link>
