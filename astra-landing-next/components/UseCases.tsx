      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          {useCases.map((useCase, index) => (
            ...
            >
              <div className="relative bg-[#faf9f6] border border-gray-200 p-8 md:p-10 transition-all duration-300 hover:border-gray-900">
                <div className="grid md:grid-cols-[1fr,auto] gap-8 items-center">
                  <div>
                    <div className="inline-flex items-center gap-2 mb-4">
                      <div className="w-8 h-8 border border-gray-900 bg-white flex items-center justify-center">
                        <useCase.icon className="w-4 h-4 text-gray-900" />
                      </div>
                    ...
                    <h3 className="text-2xl md:text-3xl font-medium text-gray-900 mb-4" style={{ fontFamily: 'var(--font-cabinet-grotesk)' }}>
                      {useCase.title}
                    </h3>
                    ...
                    <button className="inline-flex items-center gap-2 text-sm text-gray-900 font-medium group/btn">
                  ...
                  <div className="flex md:flex-col gap-4">
                    {useCase.metrics.map((metric) => (
                      <div
                        key={metric.label}
                        className="bg-white border border-gray-200 p-6 min-w-[140px] transition-all duration-300 hover:border-gray-900"
                      >
                        <div
