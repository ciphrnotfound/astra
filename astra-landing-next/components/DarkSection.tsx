    ...
    <section className="py-16 md:py-32 px-4 md:px-6 bg-[#faf9f6]">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="relative p-8 md:p-12 lg:p-16 rounded-2xl bg-white border border-gray-200 text-center overflow-hidden"
        >
          ...
          <div className="relative">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-200 bg-gray-50 text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-6 md:mb-8"
            >
              Get Started
            </motion.div>
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-600 mb-8 md:mb-10 max-w-2xl mx-auto px-4">
              Join thousands of developers using Astra to migrate, refactor, and debug code across languages.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button className="relative group overflow-hidden bg-gray-900 text-white px-5 md:px-6 py-2.5 md:py-3 rounded text-xs md:text-sm font-medium transition-all w-full sm:w-auto hover:shadow-lg">
              ...
              <button className="relative group overflow-hidden border border-gray-900 text-gray-900 px-5 md:px-6 py-2.5 md:py-3 rounded text-xs md:text-sm font-medium transition-all w-full sm:w-auto hover:text-white">
