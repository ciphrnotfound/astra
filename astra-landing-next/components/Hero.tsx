          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-medium tracking-tight text-gray-900 leading-tight" style={{ fontFamily: 'var(--font-cabinet-grotesk)' }}>
                      The codebase that
                        never 
              <br />
              <span className="text-gray-600">forgets</span>
                  

            </h1>

            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              AI-powered CLI that migrates, refactors, and debugs your code across languages. 
              From TypeScript to Rust, Python to Go—Astra understands your entire codebase.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
              <button className="relative group overflow-hidden bg-gray-900 text-white px-6 py-2.5 rounded text-sm font-medium transition-all w-full sm:w-auto hover:shadow-lg">
              ...
              <button className="relative group overflow-hidden border border-gray-900 text-gray-900 px-6 py-2.5 rounded text-sm font-medium transition-all w-full sm:w-auto hover:text-white">
            ...
            >
              ...
              <span>astra migrate --from typescript --to rust</span>
            </motion.div>
          </motion.div>
        </div>
