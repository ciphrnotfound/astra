  ...
  return (
    <div className="min-h-screen bg-[#faf9f6]">
      ...
      <main>
        ...
        <UseCases />
        <Stats />
        <section className="px-4 sm:px-6 py-12 sm:py-16 md:py-20 bg-white border-y border-gray-200">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 items-start">
            <div>
              <p className="text-xs uppercase tracking-widest text-gray-500 mb-3">Main Astra Project</p>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-medium text-gray-900 mb-4" style={{ fontFamily: 'var(--font-cabinet-grotesk)' }}>
            ...
            <div className="border border-gray-200 bg-[#111] text-[#f6f6f6] p-4 sm:p-5 overflow-x-auto">
              <pre className="text-xs sm:text-sm leading-6 sm:leading-7">
