...
use crate::memory::{HealthScores, MemoryEvent, MemoryStore};
use crate::teams::TeamManager;

pub struct HealthReport {
    pub scores: HealthScores,
    pub prev_scores: Option<HealthScores>,
...
fn trend_arrow(current: u32, prev: u32) -> &'static str {
    if current > prev + 3 {
        "▲"
...
fn trend_delta(current: u32, prev: u32) -> String {
...
fn score_bar(score: u32) -> &'static str {
    match score {
        90..=100 => "██████████",
        80..=89 => "████████░░",
        70..=79 => "███████░░░",
